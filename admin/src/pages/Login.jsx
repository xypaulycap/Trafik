...
//     const {setSaToken, setSaRole} = useContext(SubAdminContext);
...
//         setFormData({
//             ...formData,
//             userType: e.target.checked ? 'subadmin' : 'admin'
//         });
//     };
...
//                     localStorage.setItem('saRole', role); // store role
//                     setSaToken(token);
//                     setSaRole(role); // set role in context

//                 } else {
//                     toast.error(response.data.message || 'Subadmin login failed. Please try again.');
//                 }
//             } else {
...
//                     {formData.userType === 'admin' ? 'Admin Login' : 'Subadmin Login'}
//                 </h2>
...
//                             <span className="text-sm text-[#ffd700]">Admin</span>
...
//                                 />
//                                 <div className="w-11 h-6 bg-gray-700 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-[#ffd700]/20 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[#ffd700]"></div>
//                             </label>
//                             <span className="text-sm text-[#ffd700]">Subadmin</span>
//                         </div>
...
//                                     className="appearance-none block w-full px-3 py-2 border border-[#ffd700]/30 rounded-md shadow-sm bg-[#1a1a1a] text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#ffd700] focus:border-[#ffd700] sm:text-sm"
//                                 />
//                             </div>
//                         </div>
...
//                         <p className='text-white'>Are You a Menu admin? <span className='underline' onClick={navigate('/')}>Click Here</span></p>
//                     </div> */}
//                 </div>
//             </div>
//         </div>
