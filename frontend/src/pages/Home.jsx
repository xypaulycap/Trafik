...
//       description: 'Expertly crafted drinks by our master mixologists'
//     },
//     {
//       icon: '🎵',
//       title: 'Live Entertainment',
//       description: 'Enjoy live music and performances every weekend'
//     },
//     {
//       icon: '🏆',
//       title: 'VIP Experience',
//       description: 'Exclusive VIP areas for the ultimate luxury'
//     },
//     {
//       icon: '🍽️',
//       title: 'Gourmet Dining',
//       description: 'Delicious cuisine prepared by top chefs'
//     }
//   ];
...
//   return (
//     <div className="flex flex-col min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-gray-900 dark:to-gray-800">
//       {/* Hero Section */}
...
//               }`}>
//                 <div className="mb-4">
//                   <span className="inline-block px-6 py-2 bg-gradient-to-r from-amber-300 to-orange-400 text-black font-medium text-sm uppercase tracking-wider rounded-full shadow-lg">
//                     {slide.accent}
//                   </span>
//                 </div>
...
//                     className="group relative px-12 py-4 bg-transparent border-2 border-white/80 hover:border-white text-white font-semibold rounded-full overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl transform-gpu "
//                   >
...
//                     className="group relative px-12 py-4 bg-transparent border-2 border-white/80 hover:border-white text-white font-semibold rounded-full backdrop-blur-sm hover:bg-white/10 transition-all duration-300 hover:scale-105 hover:shadow-2xl transform-gpu"
//                   >
...
//               <div
//                 key={index}
//                 className={`group bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-3xl p-8 hover:bg-white/90 dark:hover:bg-gray-800/90 transition-all duration-500 hover:scale-105 hover:shadow-2xl border border-white/20 transform ${
//                   isVisible.features 
//                     ? 'translate-y-0 opacity-100' 
...
//             id="about"
//             data-animate="true"
//             className={`bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-3xl shadow-2xl p-12 md:p-16 border border-white/20 transform transition-all duration-1000 ${
...
//                     <span>Open Daily: 5:00 PM - 2:00 AM</span>
//                   </div>
//                   <div className="flex items-center gap-3 text-gray-700 dark:text-gray-300">
...
//                 className="group p-3 rounded-full bg-gradient-to-br from-pink-500 to-purple-600 hover:scale-110 transition-all duration-300 hover:shadow-lg"
//               >
...
//                 target="_blank"
//                 rel="noopener noreferrer"
//                 className="group p-3 rounded-full bg-gradient-to-br from-blue-500 to-blue-700 hover:scale-110 transition-all duration-300 hover:shadow-lg"
//               >
...
//                 target="_blank"
//                 rel="noopener noreferrer"
//                 className="group p-3 rounded-full bg-gradient-to-br from-gray-800 to-black hover:scale-110 transition-all duration-300 hover:shadow-lg"
//               >
...
//                 target="_blank"
//                 rel="noopener noreferrer"
//                 className="group p-3 rounded-full bg-gradient-to-br from-green-500 to-green-600 hover:scale-110 transition-all duration-300 hover:shadow-lg"
//               >
...
//                 © {new Date().getFullYear()} Trafik Lounge. All rights reserved. Designed with ❤️ PAULY.
//               </p>
//             </div>
//           </div>
//         </div>
