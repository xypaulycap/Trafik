  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4">
      <div className="max-w-4xl w-full">
        <h1 className="text-4xl md:text-5xl font-bold text-primary-light dark:text-primary-dark text-center mb-12">
          About Us
        </h1>
        ...
        <div className="bg-white dark:bg-accent-dark shadow-[8px_8px_0px_0px_rgba(0,0,0,0.4)]">
          ...
          <div className="p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-primary-light dark:text-primary-dark mb-6">
              Our Story
            </h2>
            <p className="text-lg text-secondary-dark dark:text-secondary-light leading-relaxed mb-6">
            ...
            {isExpanded && (
              <div className="space-y-6">
                <p className="text-lg text-secondary-dark dark:text-secondary-light leading-relaxed">
            ...
            <button
              ...
              className="text-primary-light dark:text-primary-dark font-medium hover:underline transition-all duration-300"
            >
