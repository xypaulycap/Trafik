...
const Navbar = () => {
  ...
  return (
    <nav className="relative bg-white dark:bg-gray-800 mb-8 shadow-md">
        ...
        <div className="flex justify-between h-28">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Link
              ...
              className={`px-6 py-4 rounded-lg text-lg font-medium transition-all duration-300 ml-2 ${
                isActive('/')
                  ? 'bg-gradient-to-r from-amber-300 to-yellow-400 text-gray-800 dark:text-gray-900 shadow-md'
